...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "deeec97432b4943e2087";
...
const jsFuncMap = {
  ...
  'loadSample': {"setup":(o,p)=>`${o} = new Module.maxiSample();${o}.setSample(this.translateFloat32ArrayToBuffer(event.data[key]));`, "loop":(o,p)=>`${o}.trigger();${o}.playOnce()`},
}
...
/******/ });
//# sourceMappingURL=deeec97432b4943e2087.worker.js.map