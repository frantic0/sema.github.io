...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "db5a5474bab9fc242c5a";
...
var grammar = {
    ...
    {"name": "Expression", "symbols": [(lexer.has("paramBegin") ? {type: "paramBegin"} : paramBegin), "Params", (lexer.has("paramEnd") ? {type: "paramEnd"} : paramEnd), (lexer.has("sample") ? {type: "sample"} : sample)], "postprocess": d => ({ "@sample": {"@params":d[1], "@filename":d[3], "paramBegin":d[0], "paramEnd":d[2]}} )},
...
/* harmony import */ var _eppprocessor4_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./eppprocessor4.js */ "./src/language/eppprocessor4.js");
/* harmony import */ var _eppprocessor4_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_eppprocessor4_js__WEBPACK_IMPORTED_MODULE_1__);
...
let processor = nearley_lib_nearley_js__WEBPACK_IMPORTED_MODULE_0__["Grammar"].fromCompiled(_eppprocessor4_js__WEBPACK_IMPORTED_MODULE_1__);
...
/******/ });
//# sourceMappingURL=db5a5474bab9fc242c5a.worker.js.map